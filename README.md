...
| ![لیست مزارع خالی](frontend/public/screenshots/02-farms-empty.png) | **لیست مزارع (خالی):** دعوت به ثبت اولین مزرعه با CTA سبز |
| ![لیست مزارع](frontend/public/screenshots/03-farms-list.png) | **لیست مزارع:** کارت‌های خلاصه مزرعه با مساحت، نوع خاک، موقعیت و دسترسی به جزئیات/توصیه‌ها |

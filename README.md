...
| ![آگریفارم](frontend/public/screenshots/AgriFarm.PNG) |  آگریفارم سامانه تصمیم یار هوشمند مدیریت منابع کشاورزی برای بهینه سازی مصرف آب و انرژی با هدف حمایت از احیای اکوسیستم دریاچه ارومیه، AgriFarm یک سامانه تصمیم یار هوشمند است که با ترکیب علوم داده، هوش مصنوعی و تحلیل سیستم های کشاورزی، امکان بهینه سازی مصرف آب و انرژی را فراهم می کند و نقش مهمی در احیای دریاچه ارومیه دارد.
